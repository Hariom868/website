...
<body>
    <header>
         <header>
         <a class="btn  btn-primary btn-lg btn-hover-shadow mb-3 px-4 mx-2" href="dashboard2.php">Back</a>
  ...
  <div class="card-body">
      ...
      <div class="card-text">
          <p class="login-card-description">View Patient</p>
            ...
            $dataviewing=new Database_Connection();
              $sql = $dataviewing->viewing();//it basically send the value to the function viewing 
              $count=1;
