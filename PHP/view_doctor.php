...
<body>
  ...
  <div class="card-body">
      ...
      <div class="card-text">
          <p class="login-card-description">View Doctor</p>
            ...
            $dataviewing=new Database_Connection();
              $sql = $dataviewing->viewingdoc();//it basically send the value to the function viewing 
              $count=1;
              ...
              while ($row=mysqli_fetch_array($sql)) {
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td> <?php echo "<a href='delete2.php?a=".$row['RegDate']."'>Delete</a>"; ?></td>
                    </tr>
                    <?php
                     $count=$count+1;
                     }?>
