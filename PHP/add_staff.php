...
$phone = $_POST['phone'];
$sql=$datainsert->insertstaff($Name,$Username,$Useremail,$Userpassword,$register,$branch,$phone);
if($sql)
{
...
<body>
    <header>
         <a class="btn  btn-primary btn-lg btn-hover-shadow mb-3 px-4 mx-2" href="dashboard.php">Add-Doctor</a>
          ...
          <p class="login-card-description">ADD STAFF</p>
                            <form method ="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <button class="btn btn-block login-btn mb-4">Add Staff</button>
                            </form>
